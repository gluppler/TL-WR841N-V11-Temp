// execFormatCmd_server_runtimeVer
// binary: /tmp/fw/root/usr/bin/httpd
// VA=file_off+0x400000, ELF32 MSB MIPS
// cmd: r2 -q -e scr.color=false -c "s 0x004cb978; pd 60" usr/bin/httpd
// captured: 2026-09-12T07:55:45Z
       ...
       └──< 0x004cba10      08132e5e       j sym.execFormatCmd
        ...
        ╎   0x004cba18      3c040058       lui a0, 0x58
        ╎   0x004cba1c      2484aab8       addiu a0, a0, -0x5548
        └─< 0x004cba20      08132e5e       j sym.execFormatCmd
            0x004cba24      24050001       addiu a1, zero, 1
            ;-- getFileSize:
            0x004cba28      3c1c005c       lui gp, 0x5c
            0x004cba2c      27bdff48       addiu sp, sp, -0xb8
            0x004cba30      279cfd10       addiu gp, gp, -0x2f0
            0x004cba34      afbf00b4       sw ra, 0xb4(sp)
            0x004cba38      afbc0010       sw gp, 0x10(sp)
            0x004cba3c      8f99a090       lw t9, -sym.imp.stat(gp)    ; [0x5b9da0:4]=0x5611f0 sym.imp.stat
            0x004cba40      00000000       nop
            0x004cba44      0320f809       jalr t9
            0x004cba48      27a50018       addiu a1, sp, 0x18
            0x004cba4c      8fbc0010       lw gp, 0x10(sp)
        ┌─< 0x004cba50      14400002       bnez v0, 0x4cba5c
        │   0x004cba54      2403ffff       addiu v1, zero, -1
        │   0x004cba58      8fa3004c       lw v1, 0x4c(sp)
        └─> 0x004cba5c      8fbf00b4       lw ra, 0xb4(sp)
            0x004cba60      00601021       move v0, v1
            0x004cba64      03e00008       jr ra
